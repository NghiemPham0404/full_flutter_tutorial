...
void main (){
  ...
  map1['dob'] = '12-2-2022';
  map1['name'] = "Jacky"; // TODO : change the value by assigning the current key

  print(map1['dob']);
  print(map1['name']);

  print("--------");
  map1.addAll({"gender": 1, "Nickname":"JK"}); // TODO : add many keys and values
  map1.forEach((key, value) =>
      print("$key : $value")
  );

  print("--------");
  map1["parents"] = {"mom":"Mary", "dad":"Henry"}; // TODO : add a map as value into a map
  map1.forEach((key, value) =>
      print("$key : $value")
  );
